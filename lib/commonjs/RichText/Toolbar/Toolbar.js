...
function Toolbar({
  ...
  const test = _reactNative.Appearance.getColorScheme() === 'dark' ? '#16161a95' // tiny lift in dark mode (like vibrancy)
  : '#E0E1E4';
          ...
          if (item.isDivider) {
            return /*#__PURE__*/_react.default.createElement(_reactNative.View, {
              style: {
                width: 1,
                height: '60%',
                backgroundColor: _reactNative.Appearance.getColorScheme() === 'dark' ? 'rgba(255, 255, 255, 0.3)' : 'rgba(60, 60, 67, 0.36)',
                marginHorizontal: 8,
                alignSelf: 'center'
              }
            });
